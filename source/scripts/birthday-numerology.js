...
const soulUrgeNumberData = {
    "1": {
        "personality": `As natural-born leaders, you are not only courageous but also high spirited.  
        ...
        "career": `You are a solo rider when it comes to career or business. You prefer to work alone and it is then when you outshine the most. 
        ...
        "love": `Since you like to be the boss in most places, even in love life you are likely to do the same.  
    ...
    "2": {
        "personality": `People in the category of number 2 are true peace lovers. Your emotional quotient is very high which is both bane and boon for you in life. 
        ...
        "career": `The patience in you highlights the creative side of you. Jobs like writing and art-related might fancy you and bring happiness in life. 
    ...
    "3": {
        "personality": `People who fall under this category love to be the nucleus everywhere. Since you have a charismatic aura, you end up being the centre of attraction. 
        ...
        "career": `You are quite practical and are mostly into the artistic, intellectual and creative category of work. 
    ...
    "4": {
        ...
        "career": `The fours are the kind of employees companies look for. You are focused, goal-oriented and super hard working. 
        ...
        "love": `Looking at the seriousness you keep regarding life, you are not a natural romantic. You are not the kind who can sweep his/her lover off their feet or plan a pomp surprise celebration for them. 
    ...
    "6": {
        "personality": `You are natural caretakers and are ready to go to any limit to keep your closed ones happy and content. 
        ...
        "career": `You lack self-confidence and are mostly the back-bencher in all the fields, courtesy you\'re giving nature. On the contrary, you are the one who spreads a cozy vibe at work. 
        ...
        "love": `Reading all the above qualities, it is quite evident that you are an amazing partner when it comes to relationships. 
    ...
    "7": {
        "personality": `Life path number 7 is always thirsty for knowledge. Your basic aim of life is to explore your surroundings and develop both spiritually and mentally. 
        ...
        "career": `You are a learner and also a wise man at the same time at work. You enjoy learning practically than theoretically. 
        ...
        "love": `You tend to fall in love quickly if you ignore the bug of finding self. At times the blind run for personal quest makes your partner feel out of place, lonely and unwanted. 
    ...
    "8": {
        "personality": `People who belong to the life path number 8 are hardworking and goal-oriented. Irrespective of that you are also very materialistic. 
        ...
        "love": `You are good at reading people but lack the art of expressing in a relationship. 
    ...
    "9": {
        "personality": `Generosity and emotion are two pillars of your existence. Since you are a concoction of all the numbers, you are the powerhouse of energy. 
        ...
        "career": `Life path number 9 your dedication and hard work lets you earn good money in terms of business and crack good deals for those in the job. 
